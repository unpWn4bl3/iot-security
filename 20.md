...
`sub_459864` (handle function of formMultiAPVLAN) of /bin/boa in firmware has buffer overflow vulnerability.

![image](https://github.com/unpWn4bL3/iot-security/assets/13286957/19640f80-8fed-425a-b959-7f8d6ae4e5d6)

Parameter "submit_url" is read from HTTP request into $s1_2

$s1_2 is used as 2nd parameter in sub_40bddc at 0x459b48
