...
`sub_4592A4` (handle function of formMapDel) of /bin/boa in firmware has buffer overflow vulnerability.

![image](https://github.com/unpWn4bL3/iot-security/assets/13286957/0d46628c-1a53-4ff1-809e-2e721320fd26)

Parameter "submit_url" is read from HTTP request into $v0_6

$v0_6 is used as 2nd parameter in sub_40bddc at 0x4593e4
