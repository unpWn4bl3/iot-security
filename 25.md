...
`sub_41815C` (handle function of formDMZ) of /bin/boa in firmware has buffer overflow vulnerability.

![image](https://github.com/unpWn4bL3/iot-security/assets/13286957/95d48a12-ffc1-4c1a-b0b1-b110b2f941d4)

Parameter "submit_url" is read from HTTP request into $s1_1

$s1_1 is used as 2nd parameter in sub_40bddc at 0x4184ac
