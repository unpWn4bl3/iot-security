...
`sub_44ACB8` (handle function of formDosCfg) of /bin/boa in firmware has buffer overflow vulnerability.

![image](https://github.com/unpWn4bL3/iot-security/assets/13286957/0e3ca6f9-7fa3-47e1-9beb-fc8ebb8e4610)

Parameter "submit_url" is read from HTTP request into $v0

$v0 is used as 2nd parameter in sub_40bddc at 0x44b578
