...
`sub_4160E8` (handle function of formReflashClientTbl) of /bin/boa in firmware has buffer overflow vulnerability.

![image](https://github.com/unpWn4bL3/iot-security/assets/13286957/b46db204-466f-4285-8b36-ae2a3cec2254)

Parameter "submit_url" is read from HTTP request into $v0

$v0 is used as 2nd parameter in sub_40bddc at 0x416124
