...
`sub_45361C` (handle function of formIPv6Addr) of /bin/boa in firmware has buffer overflow vulnerability.

![image](https://github.com/unpWn4bL3/iot-security/assets/13286957/65bf1080-1c1a-48fc-ae72-2e693d59736d)

Parameter "submit_url" is read from HTTP request into $s1_2

$s1_2 is used as 2nd parameter in sub_40bddc at 0x453964
