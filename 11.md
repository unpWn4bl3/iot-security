...
`sub_445AC0` (handle function of formWlanRedirect) of /bin/boa in firmware has buffer overflow vulnerability.

![image](https://github.com/unpWn4bL3/iot-security/assets/13286957/49b996de-39c7-4549-870a-368fb3c3dec8)

Parameter "redirect-url" is read from HTTP request into $v0

$v0 is used as 2nd parameter in sub_40bddc at 0x445b60
