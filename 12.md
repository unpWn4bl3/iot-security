...
`sub_441748` (handle function of formWirelessTbl) of /bin/boa in firmware has buffer overflow vulnerability.

![image](https://github.com/unpWn4bL3/iot-security/assets/13286957/d07e5743-f4e3-47d9-b525-17c9ee0cf41d)

Parameter "submit_url" is read from HTTP request into $v0

$v0 is used as 2nd parameter in sub_40bddc at 0x441784
